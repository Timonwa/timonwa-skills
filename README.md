...
| [community-triage](.claude/skills/community-triage)                               | skill   | Triages inbound issues and discussions into a prioritised, labelled queue                 |                                                         |
| [conventions-audit](.claude/commands/conventions-audit.md)                        | command | The repo against the `naming` and `code-structure` standards                              |                                                         |
| [copy-editing-house](.claude/skills/copy-editing-house)                           | skill   | Focused editing passes over copy that already exists, plus an AI-tell sweep               |                                                         |
| [daily-standup](.claude/skills/daily-standup)                                     | skill   | Turns your GitHub activity into a standup update you can paste                            |                                                         |
