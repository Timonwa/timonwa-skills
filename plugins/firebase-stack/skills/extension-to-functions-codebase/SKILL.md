...
1. **A publishable npm package** (reusable open-source package exporting V2 functions).
...
1. **Files & Scripts**: Preserve devDependencies, test framework (`jest`), and test scripts.
