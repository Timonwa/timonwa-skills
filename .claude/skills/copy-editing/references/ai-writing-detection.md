...
- Exception — a publication's own voice rule wins: where a house style mandates em-dash asides, keep the deliberate ones; this flag targets frequency and pattern, not the character itself
