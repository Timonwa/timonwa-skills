...
1. **Check Currently Installed Skills:** Determine which skills are already installed and linked for the agent at both project and global levels:
...
1. **Add Missing or Unlinked Skills:** Compare the results from Step 1 and Step 2\. For each missing or unlinked skill, follow the appropriate conditional instruction below:
...
1. **Update Existing Skills:** Update all currently installed skills to their latest versions:
